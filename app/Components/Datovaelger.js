...
export default function DatoValger({ lan, setValue, dato, name }) {
  ...
  return (
    <SimpelDato months={months} year={year} setYear={setYear} month={month} setMonth={setMonth} date={date} setValue={setValue} setDate={setDate} name={name} />
  )
